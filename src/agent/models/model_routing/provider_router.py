...
class LLMProviderRouter:
    ...
    def route(self, request: LLMRequest) -> ClientRoutingDecision:  # noqa: ARG002
        primary = self._clients[0]
        fallbacks = self._clients[1:] if self._enable_fallback else []
        return ClientRoutingDecision(primary=primary, fallbacks=fallbacks)
