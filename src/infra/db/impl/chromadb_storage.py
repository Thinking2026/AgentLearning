...
from schemas import STORAGE_CONFIG_ERROR, STORAGE_DEPENDENCY_ERROR, VectorSearchRequest, build_pipeline_error
...
class ChromaDBStorage(VectorStorage, DocumentStorage):
    ...
    def __init__(
        ...
        if not normalized_collections:
            raise build_pipeline_error(STORAGE_CONFIG_ERROR, "ChromaDB storage requires at least one collection.")
